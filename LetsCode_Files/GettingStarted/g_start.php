...
<body onload="startTimer()">
    ...
    <header class="nav-bar">
        ...
        <nav id="navbuttons">
            ...
            <?php
            if (isset($_COOKIE["signedin"])) {
                print "<a href='../EntryForm/logoutuser.php'>LOG OUT </a>";

            } else {
                print " <a href='../EntryForm/signin.php'> SIGN UP </a>";
            }
            ?>
                ...
                <tr>
                    <td>To head over to our practice section click here! <br>
                        <a href="Pages/Practice/practice_page.php">
                            <img src="images_gs/practice_button.png" alt="(Picture of practice_button)" width="75" height="75" />
                        </a>
                    </td>

                    <td>To head over to our projects section click here! <br>
                        <a href="Pages/Project/project_page.php">
                            <img src="images_gs/projects_button.png" alt="(Picture of projects_button)" width="75" height="75" />
                        </a>
                    </td>
        ...
        <div class="slideshow_outer">
            ...
            <div class="slideshow_inner">
                <a href="https://www.python.org/downloads/">
                    <img class="img1" id="starting_out" src="images_gs/starting_out.png" alt="(Picture of starting_out)" width="700" height="400" />
                </a>

                <a href="Pages/Video/video_page.php">
                    <img class="img2" id="videos" src="images_gs/videos.png" alt="(Picture of videos)" width="700" height="400" />
                </a>

                <a href="Pages/Doc/doc_page.php">
                    <img class="img3" id="documentation" src="images_gs/documentation.png" alt="(Picture of documentation)" width="700" height="400" />
                </a>

                <a href="Pages/Practice/practice_page.php">
                    <img class="img4" id="practice" src="images_gs/practice.png" alt="(Picture of practice)" width="700" height="400" />
                </a>

                <a href="Pages/Project/project_page.html">
                    <img class="img5" id="projects" src="images_gs/projects.png" alt="(Picture of projects)" width="700" height="400" />
                </a>
            </div>
